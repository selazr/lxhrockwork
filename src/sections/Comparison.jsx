        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-white/70">Natural rock</TableHead>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-white/70">Heavy, requires more support</TableCell>
            ...
            <TableRow>
              ...
              <TableCell className="text-white/70">Complex, slower</TableCell>
              <TableCell className="text-white/70">
            ...
            <TableRow>
              ...
              <TableCell className="text-white/70">Limited</TableCell>
              <TableCell className="text-white/70">
            ...
            <TableRow>
              ...
              <TableCell className="text-white/70">Difficult (each rock is unique)</TableCell>
              <TableCell className="text-white/70">
